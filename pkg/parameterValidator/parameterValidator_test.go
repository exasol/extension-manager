...
func (suite *ParameterValidatorSuite) TestValidateParameters() {
	var tests = []struct {
		...
		{name: "empty required parameter",
			...
			expected:    []ValidationResult{{Success: false, Message: `Failed to validate parameter 'My param' (param1): This is a required parameter.`}}},
		...
		{name: "invalid regex parameter",
			...
			expected:    []ValidationResult{{Success: false, Message: `Failed to validate parameter 'My param' (param1): The value has an invalid format.`}}},
		{name: "invalid boolean parameter",
			...
			expected:    []ValidationResult{{Success: false, Message: `Failed to validate parameter 'My param' (param1): Boolean value must be 'true' or 'false'.`}}},
		...
		{name: "invalid select parameter",
			...
			expected:    []ValidationResult{{Success: false, Message: `Failed to validate parameter 'My param' (param1): The value is not allowed. Possible values are 'a', 'b'.`}}},
		{name: "unknown parameter type",
			definitions: []interface{}{map[string]interface{}{"id": "param1", "name": "My param", "type": "unknown"}},
			params:      []extensionAPI.ParameterValue{{Name: "param1", Value: "c"}},
			expected:    []ValidationResult{{Success: false, Message: `Failed to validate parameter 'My param' (param1): unsupported parameter type 'unknown'`}}},
	}
